...
class ScriptRunner:
    ...
    def __init__(self,opts=None):
        ...
        <requirements>
            ...
            <requirement type="package">"%(interpreter_pack)s"</requirement>     
             <readme>
                   %(readme)s
...
<citations>
    ...
    <citation type="doi">10.1093/bioinformatics/bts573</citation>
		...
		if self.opts.parampass == "positional":
			# inputs in order then params in order
			for (ipath,iname) in self.opts.input_tab:
				a(ipath)
            #if self.opts.output_tab:
            #    a(self.opts.output_tab)
		...
		if self.opts.parampass == "argparse":
...
def main():
    ...
    assert not opts.bad_user,'UNAUTHORISED: %s is NOT authorized to use this tool until Galaxy admin adds %s to "admin_users" in the Galaxy configuration file' % (opts.bad_user,opts.bad_user)
